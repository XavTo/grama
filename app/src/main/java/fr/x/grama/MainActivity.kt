    ...
    private fun fillDbIfEmpty(db: SQLiteDatabase) {
        ...
        try {
            ...
            if (cursor.count == 0) {
                ...
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Appareil électroménager utilisé pour préparer du café.', 'cafetière')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Boisson alcoolisée obtenue par fermentation de la pomme.', 'cidre')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Temps pendant lequel le jour laisse la place à la nuit.', 'crépuscule')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Ensemble de principes et de valeurs qui guident la conduite d''un individu ou d''une société.', 'éthique')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Maladie chronique qui se caractérise par un excès de sucre dans le sang.', 'diabète')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Personne qui répare ou entretient des machines, des équipements ou des véhicules.', 'mécanicien')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Personne qui s''occupe de la santé et du bien-être des animaux.', 'vétérinaire')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Appareil optique utilisé pour agrandir ou réduire l''image d''un objet éloigné.', 'télescope')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Capacité à comprendre les émotions et les sentiments des autres.', 'empathie')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Science qui étudie les êtres vivants et leur environnement.', 'biologie')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Période de l''année où les arbres perdent leurs feuilles.', 'automne')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Ville d''Italie célèbre pour ses canaux et son architecture.', 'venise')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Instrument de musique à vent, composé d''un bec et d''un corps en métal.', 'saxophone')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Activité consistant à grimper sur des parois rocheuses à l''aide d''un équipement spécifique.', 'escalade')")
                db.execSQL("INSERT INTO TABLE_DEF (DEFINITION, WORD) VALUES ('Explication précise et concise du sens ou de la nature d''un mot ou d''une expression.', 'définition')")
            }
        } finally {
            cursor?.close()
        }
